fun main(args: Array<String>) {
    //Array methods
    //sort()
    val simpsonsA = arrayOf("Homer", "Mager","Bart","Lisa","Meggie")
    simpsonsA.sort()
    ...
    //sorted
    val simpsonsB: Array<String> = arrayOf("Homer", "Mager","Bart","Lisa","Meggie")
    ...
    val simpsonsC : Array <String> = arrayOf("Homer", "Mager","Bart","Lisa","Meggie")
    simpsonsC.sort()
    simpsonsC.reverse()
    ...
    //indexOf()
    val simpsonsD = arrayOf("Homer", "Mager","Bart","Lisa","Meggie")
    val simpson = "Lisa"
